...
public final class DefaultValues {
    public static final ITextComponent COMMA = new TranslationTextComponent(SFLSMod.prefixMsg("comma"));
    public static final ITextComponent SPACE = new TranslationTextComponent(SFLSMod.prefixMsg("space"));
